...
<header id="banner" class="body">
	...
	<c:url var="returnstocks" value="/wom/cms/returnstocks"/>
	...
	<c:url var="poamendment" value="/wom/cms/poamendment"/>
	<nav>
		<ul>
			<li><a href="#">Product</a>
				<ul>
					...
					<li><a href="${returnstocks}">Return Stocks</a></li>
				</ul>
			</li>
			...
			<li class="active"><a href="#">Orders</a>
	 			<ul>
					...
					<li><a href="${poamendment}">PO Amendments</a></li>
				</ul>
	 		</li>
	 		<li>
