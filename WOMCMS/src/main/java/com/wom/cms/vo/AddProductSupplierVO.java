...
public class AddProductSupplierVO implements Serializable{
	
	public AddProductSupplierVO() {}
	private static final long serialVersionUID = 6326053509882158341L;
	
	private String supplierCode;
	private String supplierPackqty;
	...
	public String getSupplierPackqty() {
		return supplierPackqty;
	}

	public void setSupplierPackqty(String supplierPackqty) {
		this.supplierPackqty = supplierPackqty;
	}
